        ...
        <section className={className}>
            ...
            <form onSubmit={submit} className="mt-6 space-y-6">
                <div>
                    ...
                    <TextInput
                        id="name"
                        className="mt-1 block w-full dark:bg-transparent"
                        value={data.name}
                    ...
                    <InputError className="mt-2 dark:text-white" message={errors.name} />
                </div>
                ...
                <div>
                    ...
                    <InputError className="mt-2 dark:text-white" message={errors.email} />
                </div>
